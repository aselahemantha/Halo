package com.nebulatech.halo.services
...
import com.nebulatech.halo.MainActivity
...
class LocationForegroundService : Service() {
    ...
    @Inject
    lateinit var userPreferencesRepository: com.nebulatech.halo.data.repository.UserPreferencesRepository

    @Inject
    lateinit var geofenceManager: com.nebulatech.halo.domain.GeofenceManager
    ...
    private fun triggerAlarm(alarm: Alarm) {
        ...
        serviceScope.launch {
            ...
            val history = com.nebulatech.halo.domain.model.AlarmHistory(
                alarmId = alarm.id,
