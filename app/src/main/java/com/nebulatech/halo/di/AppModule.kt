package com.nebulatech.halo.di

import android.app.Application
import androidx.room.Room
import com.nebulatech.halo.data.local.AlarmDao
import com.nebulatech.halo.data.local.AlarmDatabase
import com.nebulatech.halo.data.repository.AlarmRepositoryImpl
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideAlarmHistoryDao(db: AlarmDatabase): com.nebulatech.halo.data.local.AlarmHistoryDao {
        return db.alarmHistoryDao()
    }

    @Provides
    @Singleton
    fun provideAlarmRepository(dao: AlarmDao, historyDao: com.nebulatech.halo.data.local.AlarmHistoryDao): AlarmRepository {
