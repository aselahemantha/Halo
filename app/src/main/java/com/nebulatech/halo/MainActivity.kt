...
import com.nebulatech.halo.ui.viewmodel.MainViewModel
import com.nebulatech.halo.ui.navigation.HaloNavHost
import com.nebulatech.halo.ui.navigation.Screen
import com.nebulatech.halo.ui.theme.HaloTheme
            ...
            HaloTheme(darkTheme = darkTheme, dynamicColor = dynamicColor) {
                ...
                Surface(
                    ...
                    androidx.compose.foundation.layout.Box(modifier = Modifier.fillMaxSize()) {
                        ...
                        // Network Banner
                        if (networkStatus == com.nebulatech.halo.data.network.ConnectivityObserver.Status.Lost ||
                            networkStatus == com.nebulatech.halo.data.network.ConnectivityObserver.Status.Unavailable ||
                            networkStatus == com.nebulatech.halo.data.network.ConnectivityObserver.Status.Losing
                        ) {
                            com.nebulatech.halo.ui.components.OfflineBanner(
                                modifier = Modifier
